...
<body>
    ...
    <div class="page-align">
        <div class="butt-block">
            <a href="reg_coop.php" class="reg-butt-active">Сотрудник</a>
            <a href="reg_leader.php" class="reg-butt">HR-руководитель</a>
        </div>
    </div>
    <div class="page-align">
		  <div class="stepsForm">
        ...
        ?>
                    ...
                    <ul class="sf-content"> 
                        <li><div class="ttl-name">Выберите компанию:</div>
                            <div class="">
                                <?php
                                    include("connect.php");
                                    $query=mysql_query("SELECT id_comp,name_comp FROM company ORDER BY name_comp");
                                    echo "<br><select name='comp' style='font-size:36px;'>";
                                        while ($company=mysql_fetch_array($query, MYSQL_NUM))
                                            {
